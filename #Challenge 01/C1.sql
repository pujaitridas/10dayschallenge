/*#Challenge 01
    ...
    Once the table has been created help Daniel who runs a top- end car showroom find some insights in the data.
    What is the total revenue generated by the sales of “Sedan” cars in each year?*/
...
SELECT 
    style,
    YEAR(purchased_date) AS `Sales_Year`,
